...
%>
	...
	<form id="form1" runat="server">
		<div>
			...
			<asp:RequiredFieldValidator ID="valUserID" runat="server" ErrorMessage="아이디를 입력하세요" ControlToValidate="txtUserID" SetFocusOnError="true"></asp:RequiredFieldValidator> <br />
